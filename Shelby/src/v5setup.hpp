...
/* misc macros */
#define SPAGHETTI LEFT_DRIVE(127); RIGHT_DRIVE(-127); master.rumble(".-.-.-.-.-"); master.set_text(E_CONTROLLER_MASTER, 0, 0, "this should be fun"); fly(0); intake.move(0); lift.move(0);
